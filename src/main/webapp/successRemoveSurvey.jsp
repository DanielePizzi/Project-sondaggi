...
<title>Rimozione effttuata con successo</title>
<style>
body{
...
<body>
		<center><h1>Rimozione sondaggio effettuata con successo</h1>
	<br>
	
		<form action="categorieESondaggi" >
			<button type="submit" name="categorie e sondaggi">
		   		Categorie e Sondaggi
			</button>
		</form></center>
</body>
</html>